...
from cml_driver.schemas.common import IPAddress, UUID4Type
from cml_driver.schemas.node_definitions import LibvirtDomainDrivers
from cml_driver.schemas.nodes import NodeLabel
