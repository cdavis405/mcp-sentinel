...
from cml_driver.schemas.annotations import AnnotationResponse, AnnotationUpdate
from cml_driver.schemas.common import MACAddress, UUID4Type
from cml_driver.schemas.interfaces import InterfaceLabel, InterfaceSlot, InterfaceType
from cml_driver.schemas.labs import LabDescription, LabNotes, LabTitle
from cml_driver.schemas.links import (
    LinkConditionConfiguration,
    LinkLabel,
    LinkWithConditionConfig,
)
from cml_driver.schemas.nodes import NodeConfiguration, NodeDefined
from cml_driver.schemas.smart_annotations import (
    SmartAnnotationBase,
